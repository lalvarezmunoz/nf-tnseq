...
myfiles1 <- list.files("C:/git/nf-tnseq/results/cutadapt", pattern= "_step3_cutadapt.log", full.names = TRUE)

data_cutadapt <- lapply(myfiles1, function(x){
  file <- readLines(x)  #read cutadapt log files
