...
function [Chr1_names, Chr1_starts, Chr1_ends] = genome_parser(GTFtable, chr_search_term, chrom_end)
GTF_file=GTFtable;
...
% Next step is to map reads from SAM file to these start and end points and
% assign a locus to each read observed.